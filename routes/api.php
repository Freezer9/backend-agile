...
Route::group([
    ...
    Route::get('/userfavorite/{id}', [UserFavoriteController::class, 'index']);
    Route::post('/userfavorite', [UserFavoriteController::class, 'store']);
    Route::delete('/userfavorite/{user_id}/{id}', [UserFavoriteController::class, 'destroy']);
});
