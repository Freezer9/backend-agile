...
Route::group([
    ...
    Route::get('/user/{id}/userrecipe', [UserRecipeController::class, 'index']);
    Route::post('/user/{id}/userrecipe', [UserRecipeController::class, 'store']);
    Route::get('/userrecipe/{id}', [UserRecipeController::class, 'show']);
